...
public class FileUserDaoTest {
    ...
    public void setUp() throws Exception {
        ...
        try (FileWriter file = new FileWriter(userFile.getAbsolutePath())) {
            file.write("testertester;Antti Ojala\n");
        }
    ...
    public void usersAreReadCorrectlyFromFile() {
        ...
        assertEquals("Antti Ojala", user.getName());
    ...
    public void savedUserIsFound() throws Exception {
        User nawUser = new User("mallikas", "Mikko Malli");
        dao.create(nawUser);
        
        User user = dao.findByUsername("mallikas");
        assertEquals("Mikko Malli", user.getName());
        assertEquals("mallikas", user.getUsername());
    }
